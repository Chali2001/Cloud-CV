...
class PexelsBackground {
    constructor() {
        ...
        this.currentImage = 'https://images.pexels.com/photos/128362/pexels-photo-128362.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'; // Bridge image as default
    ...
    waitForConfig() {
        const checkConfig = () => {
            if (window.PEXELS_API_KEY) {
                ...
                // If no API key found quickly, just use the default bridge image
                console.log('No API key found immediately, using default styling');
